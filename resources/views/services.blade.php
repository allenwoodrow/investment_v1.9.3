...
<div id="live-activity-tooltip"></div>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current"><a href="{{ url('/services') }}">{{ __('messages.services') }}</a></li>
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(https://azim.hostlin.com/Counsolve/assets/images/background/page-title-bg.jpg);">
        <div class="auto-container">
            <div class="content-box">
                ...
                <ul class="bread-crumb clearfix">
                    ...
                    <li>{{ __('messages.services_breadcrumb') }}</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ __('messages.forex_trading') }}</h3>
                                <p>{{ __('messages.forex_full_desc') }}</p>
                                <div class="link"><a href="{{ url('auth/register') }}"><span>{{ __('messages.start_investing_today') }}</span></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ __('messages.bitcoin_mining') }}</h3>
                                <p>{{ __('messages.bitcoin_full_desc') }}</p>
                                <div class="link"><a href="{{ url('auth/register') }}"><span>{{ __('messages.start_investing_today') }}</span></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ __('messages.oil_gas') }}</h3>
                                <p>{{ __('messages.oil_gas_full_desc') }}</p>
                                <div class="link"><a href="{{ url('auth/register') }}"><span>{{ __('messages.start_investing_today') }}</span></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ __('messages.real_estate') }}</h3>
                                <p>{{ __('messages.real_estate_full_desc') }}</p>
                                <div class="link"><a href="{{ url('auth/register') }}"><span>{{ __('messages.start_investing_today') }}</span></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ __('messages.gold_investments') }}</h3>
                                <p>{{ __('messages.gold_full_desc') }}</p>
                                <div class="link"><a href="{{ url('auth/register') }}"><span>{{ __('messages.start_investing_today') }}</span></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one">
                            <div class="inner-box">
                                ...
                                <h3>{{ __('messages.sports_investments') }}</h3>
                                <p>{{ __('messages.sports_full_desc') }}</p>
                                <div class="link"><a href="{{ url('auth/register') }}"><span>{{ __('messages.start_investing_today') }}</span></a></div>
                            </div>
                        </div>
                    </div>
