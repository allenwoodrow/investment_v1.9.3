...
<div id="live-activity-tooltip"></div>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current"><a href="{{ url('/plans') }}">{{ __('messages.investment_plans') }}</a></li>
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(https://azim.hostlin.com/Counsolve/assets/images/background/chooseus-bg-2.jpg);">
        <div class="auto-container">
            <div class="content-box">
                <div class="title">
                    <h1>{{ __('messages.investment_plans') }}</h1>
                </div>
                <ul class="bread-crumb clearfix">
                    <li><a href="{{ url('/') }}">{{ __('messages.home_breadcrumb') }}</a></li>
                    <li>{{ __('messages.plans_breadcrumb') }}</li>
                </ul>
            </div>
        </div>
    </section>
                        ...
                        <div class="pricing-table">
                            ...
                            <div class="table-content">
                                <ul class="feature-list clearfix">
                                    ...
                                    <li>{{ __('messages.max_deposit') }}: Unlimited</li>
    ...
    <section class="about-style-two sec-pad">
        <div class="auto-container">
            <div class="sec-title centred">
                <span class="sub-title">{{ __('messages.plan_comparison') }}</span>
                <h2>{{ __('messages.find_perfect_plan') }}</h2>
            </div>
            <div class="row clearfix">
                            ...
                            <table class="table table-bordered text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('messages.bronze_plan') }}</th>
                                        <th>{{ __('messages.silver_plan') }}</th>
                                        <th>{{ __('messages.gold_plan') }}</th>
                                        <th>{{ __('messages.diamond_plan') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>{{ __('messages.min_deposit') }}</td>
                                        <td>$100</td>
                                        <td>$1,000</td>
                                        <td>$5,000</td>
                                        <td>$20,000</td>
                                    ...
                                    <tr>
                                        <td>{{ __('messages.profit_interval') }}</td>
                                        <td>{{ __('messages.every_24_hours') }}</td>
                                        <td>{{ __('messages.every_48_hours') }}</td>
                                        <td>{{ __('messages.every_48_hours') }}</td>
                                        <td>{{ __('messages.every_48_hours') }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('messages.min_withdrawal') }}</td>
                                        <td>$5</td>
                                        <td>$50</td>
                                        <td>$100</td>
                                        <td>$500</td>
                                    ...
                                    <tr>
                                        <td>{{ __('messages.auto_reinvest') }}</td>
                                        <td>Yes</td>
                                        <td>Yes</td>
                                        <td>Yes</td>
                                        <td>Yes</td>
                                    ...
                                    <tr>
                                        <td>{{ __('messages.support_level') }}</td>
                                        <td>{{ __('messages.standard') }}</td>
                                        <td>{{ __('messages.priority_support') }}</td>
                                        <td>{{ __('messages.vip_support') }}</td>
                                        <td>{{ __('messages.dedicated_manager') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
