                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="handleLogin">
                      <div>
                        ...
                        <InputText id="email1" type="text" placeholder="email " class="w-full md:w-30rem mb-5" style="padding: 1rem" v-model="form.email" />
    ...
    setup() {
      ...
      const handleLogin = async () => {
        ...
        .then((response) => {
          ...
          toast.info('Login Failed', message.message ?? 'Invalid email and password')
        })
      };
